...
# ╔═╡ 5ff722d5-4ed6-4b1e-925d-18363ba140d9
md"""
---
"""
...
# ╔═╡ b1a5a423-a9c3-4a72-aac3-793cb531e08b
md"""
---
"""
...
md"""
¿Existe algún resultado sobre esto? Por ejemplo para $k=9$ y $q=3$ las aristas horizontales a partir de la segunda fila tienen una razón en general cercana a $0.75$ mientras que para el resto de las aristas $0.666$.
"""

# ╔═╡ ab0b1b81-4901-4a25-ad99-fee72bc33407
md"""
---
"""
...
# ╔═╡ 4d18c6dc-ad27-4047-b20f-4d51473483ca
md"""
---
"""
...
begin
pb1 = plot(dfa.q, dfa.Res⭑, label="Respuesta Real", linewidth=0.5, marker=:star, color=:red, markersize=5, size=(550, 350), yscale=:log10, leg=:right, ylimits = (1e0, 1e5), titlefontsize=13)
...
pb2 = plot(dfa.q, dfa.R_err, label="eps = 0.1", color=:blue, xlabel="q", ylabel="Error relativo (%)", marker=:rect, size=(550, 350), title="Comparación errores relativos L_2", titlefontsize=15)

plot!(dfb.q, dfb.R_err, label="eps = 1", marker=:diamond, color=:orange)

pb3 = bar(dfa.q, dfa.Time, label="eps = 0.1", color=:blue, xlabel="q", ylabel="Tiempo (Segundos)", size=(550, 350), bar_width=0.5, title="Comparación tiempos L_2", titlefontsize=13)

bar!(dfb.q, dfb.Time, label="eps = 1", color=:orange, ylabel="Tiempo(segs)", size=(550, 350), bar_width=0.6)
	
layout = @layout [a b; c]
plot(pb1, pb3, pb2, layout=layout, size=(1000,800))
end
...
md"""
**Nota:** Estos cálculos se hicieron con una versión no optimizada del código, de ahí los tiempos de ejecución.
"""
...
begin
pa1 = plot(dfc.q, dfc.Res⭑, label="Respuesta Real", linewidth=0.5, marker=:star, color=:red, markersize=5, size=(550, 350), yscale=:log10, leg=:right, ylimits = (1e0, 1e12), titlefontsize=13)
...
pa2 = plot(dfc.q, dfc.R_err, label="eps = 0.31", color=:blue, xlabel="q", ylabel="Error relativo (%)", marker=:rect, size=(550, 350), title="Comparación errores relativos L_3", titlefontsize=15)

plot!(dfd.q, dfd.R_err, label="eps = 1", marker=:diamond, color=:orange)

pa3 = bar(dfc.q, dfc.Time, label="eps = 0.31", xlabel="q", color=:blue, size=(550, 350), bar_width=0.5, title="Comparación tiempos L_3", titlefontsize=13)

bar!(dfd.q, dfd.Time, label="eps = 1", color=:orange, ylabel="Tiempo(segs)", size=(550, 350), bar_width=0.6)
	
plot(pa1, pa3, pa2, layout=layout, size=(1000,800))
end
...
begin
pc1 = plot(dfe.q, dfe.Res⭑, label="Respuesta Real", linewidth=0.5, marker=:star, color=:red, markersize=5, size=(550, 350), yscale=:log10, leg=:right, ylimits = (1e0, 1e20), titlefontsize=13)
...
pc2 = plot(dfe.q, dfe.R_err, label="eps = 0.1", color=:blue, xlabel="q", ylabel="Error relativo (%)", marker=:rect, size=(550, 350), title="Comparación errores relativos L_4", titlefontsize=15)
...
pc3 = bar(dfe.q, dfe.Time, label="eps = 0.1", color=:blue, xlabel="q", ylabel="Tiempo (Segundos)", size=(550, 350), bar_width=0.5, title="Comparación tiempos L_4", titlefontsize=13)
...
plot(pc1, pc3, pc2, layout=layout, size=(1000,800))
end
...
begin
pd1 = plot(dfh.q, dfh.Res⭑, label="Respuesta Real", linewidth=0.5, marker=:star, color=:red, markersize=5, size=(550, 350), yscale=:log10, leg=:right, ylimits = (1e0, 1e30), titlefontsize=13)
...
pd2 = plot(dfh.q, dfh.R_err, label="eps = 0.1", color=:blue, xlabel="q", ylabel="Error relativo (%)", marker=:rect, size=(550, 350), title="Comparación errores relativos L_5", titlefontsize=15)
...
pd3 = bar(dfh.q, dfh.Time, label="eps = 0.1", color=:blue, xlabel="q", ylabel="Tiempo (Segundos)", size=(550, 350), bar_width=0.5, title="Comparación tiempos L_5", titlefontsize=13)
...
plot(pd1, pd3, pd2, layout=layout, size=(1000,800))
end
...
begin
pe1 = plot(dfk.q, dfk.Res⭑, label="Respuesta Real", linewidth=0.5, marker=:star, color=:red, markersize=5, size=(550, 350), yscale=:log10, leg=:right, ylimits = (1e0, 1e42), titlefontsize=13)
...
pe2 = plot(dfk.q, dfk.R_err, label="eps = 0.2", color=:blue, xlabel="q", ylabel="Error relativo (%)", marker=:rect, size=(550, 350), title="Comparación errores relativos L_6", titlefontsize=15)
...
pe3 = bar(dfk.q, dfk.Time, label="eps = 0.2", color=:blue, xlabel="q", ylabel="Tiempo (Segundos)", size=(550, 350), bar_width=0.5, title="Comparación tiempos L_6", titlefontsize=13)
...
plot(pe1, pe3, pe2, layout=layout, size=(1000,800))
end
...
begin
pf1 = plot(dfn.q, dfn.Res⭑, label="Respuesta Real", linewidth=0.5, marker=:star, color=:red, markersize=5, size=(550, 350), yscale=:log10, leg=:right, ylimits = (1e0, 1e60), titlefontsize=13)
...
pf2 = plot(dfn.q, dfn.R_err, label="eps = 0.4", color=:blue, xlabel="q", ylabel="Error relativo (%)", marker=:rect, size=(550, 350), title="Comparación errores relativos L_7", titlefontsize=15)
...
pf3 = bar(dfn.q, dfn.Time, label="eps = 0.4", color=:blue, xlabel="q", ylabel="Tiempo (Segundos)", size=(550, 350), bar_width=0.5, title="Comparación tiempos L_7", titlefontsize=13)
...
begin
pg1 = plot(dfq.q, dfq.Res⭑, label="Respuesta Real", linewidth=0.5, marker=:star, color=:red, markersize=5, size=(550, 350), yscale=:log10, leg=:right, ylimits = (1e0, 1e60), titlefontsize=13)
...
pg2 = plot(dfq.q, dfq.R_err, label="eps = 0.4", color=:blue, xlabel="q", ylabel="Error relativo (%)", marker=:rect, size=(550, 350), title="Comparación errores relativos L_8", titlefontsize=15)
...
pg3 = bar(dfq.q, dfq.Time, label="eps = 0.4", color=:blue, xlabel="q", ylabel="Tiempo (Segundos)", size=(550, 350), bar_width=0.5, title="Comparación tiempos L_8", titlefontsize=13)
...
plot(pg1, pg3, pg2, layout=layout, size=(1000,800))
end
...
begin
pt1 = plot(dft.q, dft.Res⭑, label="Respuesta Real", linewidth=0.5, marker=:star, color=:red, markersize=5, size=(550, 350), yscale=:log10, leg=:bottomright, ylimits = (1e0, 1e80), title="Estimación vs Respuesta Real L_9", titlefontsize=13);
...
pt2 = plot(dft.q, dft.R_err, label="eps = 0.5", color=:blue, xlabel="q", ylabel="Error relativo (%)", marker=:rect, size=(550, 350), title="Comparación errores relativos L_9", titlefontsize=15)
...
pt3 = bar(dft.q, dft.Time, label="eps = 0.5", color=:blue, xlabel="q", ylabel="Tiempo(seg)", size=(550, 350), bar_width=0.5, title="Comparación tiempos L_9", titlefontsize=13)
...
html"""
<h4>Análisis sobre el promedio de los ratios.</h4>
"""

# ╔═╡ be3186c4-c5c9-45f5-9050-4856b70bb2e8
begin
plot(dfe.q, dfa.Mean_r, label="k = 2", color=:blue, ylabel="Promedio ratio", marker=:circle, size=(550, 350), alpha = 0.5, leg=:right)
